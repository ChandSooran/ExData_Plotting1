...
## Make png plot
png(filename = "C://Chand Sooran/Johns Hopkins/Exploratory Data/Course Project 1/plot4.png")

## Make histogram in png file
par(mfrow = c(2,2))
plot(short$datetime, short$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
plot(short$datetime, short$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
with(short, plot(datetime, Sub_metering_1, type = "n", xlab = "", ylab = "Energy sub metering"))
with(short, points(datetime, Sub_metering_1, col = "black", type = "l"))
with(short, points(datetime, Sub_metering_2, col = "red", type = "l"))
with(short, points(datetime, Sub_metering_3, col = "blue", type = "l"))
legend("topright", col = c("black","red", "blue"), legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), lwd = 1)
plot(short$datetime, short$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
