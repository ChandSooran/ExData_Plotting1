...
## Make png plot
png(filename = "C://Chand Sooran/Johns Hopkins/Exploratory Data/Course Project 1/plot1.png")

## Make histogram in png file
hist(short$Global_active_power, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)", ylim = c(0,1200))
